...
{
	public class OutlineStep : BaseStep
	{
		...
		void ProcessMethod (MethodDefinition method)
		{
			...
			bool lastInstructionWasInvalid = false;
			foreach (var instruction in method.Body.Instructions) {
				if (!IsInstructionEligibleForOutlining (instruction)) {
					if (lastInstructionWasInvalid)
						continue;

					Context.OutlineInstructionsAsStrings.Add (null);
					lastInstructionWasInvalid = true;
					continue;
				}
		...
		bool IsInstructionEligibleForOutlining (Instruction instruction)
		{
