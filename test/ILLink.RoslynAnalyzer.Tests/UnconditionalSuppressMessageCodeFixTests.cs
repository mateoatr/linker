...
public class C
{
    ...
    int M2() => M1();
			...
			return VerifyUnconditionalSuppressMessageCodeFixWithRUC (
				...
				VerifyCSUSMwithRUC.Diagnostic (RequiresUnreferencedCodeAnalyzer.RequiresUnreferencedCodeRule).WithSpan (7, 17, 7, 21).WithArguments ("C.M1()", " message.", ""),
				},
...
public class C
{
    ...
    int M2() => M1();
			...
			return VerifyUnconditionalSuppressMessageCodeFixWithRAF (
				...
				baselineExpected: new[] {
				// /0/Test0.cs(7,17): warning IL2026: Using method 'C.M1()' which has 'RequiresUnreferencedCodeAttribute' can break functionality when trimming application code. message.
				VerifyCSUSMwithRAF.Diagnostic (Constants.WarningCodes.IL3002).WithSpan (7, 17, 7, 21).WithArguments ("C.M1()", " message.", "")
				},
				fixedExpected: Array.Empty<DiagnosticResult> ());
		}
...
";
			return VerifyUnconditionalSuppressMessageCodeFixWithRAF (
				...
				VerifyCSUSMwithRAF.Diagnostic(Constants.WarningCodes.IL3000).WithSpan (7, 27, 7, 44).WithArguments ("System.Reflection.Assembly.Location", "", ""),
				...
				VerifyCSUSMwithRAF.Diagnostic(Constants.WarningCodes.IL3001).WithSpan (9, 13, 9, 32).WithArguments("System.Reflection.Assembly.GetFiles()", "", ""),
				},
				fixedExpected: Array.Empty<DiagnosticResult> ());
		}
    ...
    int M2 => M1();
			...
			return VerifyUnconditionalSuppressMessageCodeFixWithRUC (
				...
				baselineExpected: new[] {
					...
					VerifyCSUSMwithRUC.Diagnostic (RequiresUnreferencedCodeAnalyzer.RequiresUnreferencedCodeRule).WithSpan(10, 15, 10, 19).WithArguments("C.M1()", " message.", "")
				},
				fixedExpected: Array.Empty<DiagnosticResult> ());
		}
    ...
    public static C InitC() {
        ...
        return cObject;
			...
			return VerifyUnconditionalSuppressMessageCodeFixWithRAF (
				...
				VerifyCSUSMwithRAF.Diagnostic (Constants.WarningCodes.IL3002).WithSpan (6, 50, 6, 55).WithArguments ("C.InitC()", "", ""),
				},
				fixedExpected: Array.Empty<DiagnosticResult> ());
		}
        ...
        return Wrapper;
			...
			return VerifyUnconditionalSuppressMessageCodeFixWithRUC (
				...
				baselineExpected: new[] {
					...
					VerifyCSUSMwithRUC.Diagnostic (RequiresUnreferencedCodeAnalyzer.RequiresUnreferencedCodeRule).WithSpan(12, 28, 12, 32).WithArguments("C.M1()", " message.", "")
				},
				fixedExpected: Array.Empty<DiagnosticResult> ());
		}
...
public class C
{
    ...
    public C () => M1();
			...
			return VerifyUnconditionalSuppressMessageCodeFixWithRUC (
				...
				baselineExpected: new[] {
					// /0/Test0.cs(10,15): warning IL2026: Using method 'C.M1()' which has 'RequiresUnreferencedCodeAttribute' can break functionality when trimming application code. message.
					VerifyCSUSMwithRUC.Diagnostic (RequiresUnreferencedCodeAnalyzer.RequiresUnreferencedCodeRule).WithSpan(10, 20, 10, 24).WithArguments("C.M1()", " message.", "")
				},
				fixedExpected: Array.Empty<DiagnosticResult> ());
		}
        ...
        remove { }
			...
			return VerifyUnconditionalSuppressMessageCodeFixWithRUC (
				...
				baselineExpected: new[] {
					...
					VerifyCSUSMwithRUC.Diagnostic (RequiresUnreferencedCodeAnalyzer.RequiresUnreferencedCodeRule).WithSpan(14, 21, 14, 25).WithArguments("C.M1()", " message.", "")
				},
				fixedExpected: Array.Empty<DiagnosticResult> ());
		}
	}
